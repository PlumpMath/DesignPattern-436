 ...
 *  - I want the class object to be able to choose from (not flying, fly with win)
 *  - When you need to use one of several behaviors dynamically.
 *  - often reduces long lists of conditionals
 *  - avoid duplicate code
 *  - keeps class changes from forcing other class changes
 *  - can hide complicated/secret code from the users
...
public class Animal {
	...
	*/
    ...
    public String tryToFlyHigh() {
        return flyingInstance.fly();
    }

    public void setFlyingAbilityForInstance(Flys flyType) {
        this.flyingInstance = flyType;
    }
}
